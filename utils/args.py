...
device_group.add_argument("--directml", type=int, nargs="?", metavar="DIRECTML_DEVICE", const=-1, help="set prefered device to directml")
...
vram_group.add_argument("--novram", action="store_true", help="To use the CPU for everything (slow).")
